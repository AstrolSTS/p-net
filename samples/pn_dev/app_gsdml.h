...
#define APP_NO_OF_GENERATORS                1
#define APP_GSDML_INPUT_DATA_DIGITAL_SIZE   (4 * APP_NO_OF_GENERATORS) /* bytes */
#define APP_GSDML_OUTPUT_DATA_DIGITAL_SIZE  (3 * APP_NO_OF_GENERATORS)/* bytes */
